...
export const NotFound: React.FC<NotFoundProps> = ({ setCurrentPage }) => {
  return (
    <div className="max-w-2xl bg-brand-offwhite border border-brand-cream/20 rounded-md p-10 sm:p-16 mx-auto text-center space-y-6 my-16 shadow-xs">
      ...
      <div className="space-y-2">
        <h1 className="font-editorial text-4xl font-bold text-brand-cream">404</h1>
        <h2 className="font-editorial text-2xl font-bold text-brand-cream">Lost in the Woods</h2>
      ...
      <div className="pt-4 flex justify-center gap-3">
        ...
        <button
          ...
          className="px-6 py-3 border border-brand-forest text-brand-cream hover:bg-brand-purple-dark transition-all text-xs tracking-widest uppercase font-bold rounded-xs cursor-pointer flex items-center gap-1.5"
        >
          Explore Shop
